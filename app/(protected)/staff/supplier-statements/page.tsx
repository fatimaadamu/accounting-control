  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Supplier statements</CardTitle>
          <CardDescription>Short or full supplier balances.</CardDescription>
        </CardHeader>
        <CardContent>
          <form className="grid gap-4 md:grid-cols-3" method="get">
            <div className="space-y-2">
              <Label>Supplier</Label>
              <Select name="supplier" defaultValue={selectedId}>
          ...
          <CardContent>
            {mode === "short" ? (
              <p className="text-sm text-zinc-600">
                Supplier balance as at today: {balance.toFixed(2)}
              </p>
            ) : (
              <Table>
                <TableHeader>
